...
.
├── data/
│   ├── raw/                          # Inside Airbnb source files (not committed — see below)
│   ├── interim/                      # cleaned silver-layer parquet (generated)
│   └── airbnb_warehouse.duckdb       # DuckDB star schema (generated)
├── docs/
│   └── data_quality_report.csv       # generated by notebook 02
├── notebooks/
│   ├── 01_dataset_exploration.ipynb  # §2 Dataset Familiarization
│   ├── 02_data_engineering.ipynb     # §3.1–3.5 Ingestion, cleaning, star schema, pipeline
│   ├── 03_eda.ipynb                  # §4 Exploratory Data Analysis
│   ├── 04_statistical_analysis.ipynb # §5 Statistical Analysis (H1–H5)
│   ├── 05_data_science.ipynb         # §6 Price prediction + clustering
│   └── 06_ai_nlp.ipynb               # §7 VADER sentiment analysis
├── dashboard/
